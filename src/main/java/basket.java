...
public class basket {
    ...
    public basket(String fileName) {
        ...
        try {
            ...
            while ((myLine = bufRead.readLine()) != null) {
                ...
                // I'm also assuming no item names will include " at ", so there will only be one " at " in each line.
                ...
                // I'm going to do a quick and dirty method here of a brute force match check of known exempt (from examples) item descriptions.
    ...
    public int getTotalTaxes()  { return totalTaxes; }
